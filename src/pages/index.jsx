  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex">
        <Button href="https://www.erinjerri.substack.com"><Button type="submit" className="ml-4 flex-none">
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button href="https://bit.ly/ErinJerriTalksNAAAP23" variant="secondary" className="group mt-6 w-full">
        Download Talks in CV 
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <div className="mt-6 flex gap-6">
            ...
            />
            <SocialLink
              href="https://linkedin.com/in/erinjerri"
