...
In 2018, I was approached to write a book on how to create Pokemon Go from scrach in augmented reality (AR) across 6 different Headmounted Displays (HMDs). I pitched this to my publisher, and was successful in landing a deal. With my co-editors, Steve Lukas (formerly Magic Leap, currently QualComm), and Vasanth Mohan (a.k.a. FusedVR on YouTube), we published the book.  Much thanks to the sponsorship and guidance of design and engineering legends, John Maeda, and Tony Parisi who wrote the foreword and afterword for the book.
